...
python main_single.py --dataset cifar10 --model cnn --num_classes 10 --epochs 160 --opt SGD --body_lr 0.1 --head_lr 0.1 --body_m 0.9 --head_m 0.9 --results_save run1
python main_single.py --dataset cifar10 --model cnn --num_classes 10 --epochs 160 --opt SGD --body_lr 0.1 --head_lr 0.0 --body_m 0.9 --head_m 0.0 --results_save run1
python main_single.py --dataset cifar10 --model cnn --num_classes 10 --epochs 160 --opt SGD --body_lr 0.0 --head_lr 0.1 --body_m 0.0 --head_m 0.9 --results_save run1
